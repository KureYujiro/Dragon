...
public class Config {
    ...
    public void loadConfig() {
		...
		config.addDefault("Dragon.DragonsBreath.Cooldown", Long.valueOf(2000));
		config.addDefault("Dragon.DragonsBreath.ChargeTime", Long.valueOf(2000));
		...
		config.addDefault("Dragon.DragonsJet.ManaTotal", Double.valueOf(100.0));
		...
		config.addDefault("Dragon.DragonsJet.LeapSpeed", Double.valueOf(1.0));
		...
		config.addDefault("Dragon.DragonsComet.Cooldown", Long.valueOf(2000));
		...
		config.addDefault("Dragon.DragonsComet.Speed", Double.valueOf(1));
		config.addDefault("Dragon.DragonsComet.Damage", Double.valueOf(2.5));
		config.addDefault("Dragon.DragonsComet.Knockback", Double.valueOf(1.0));
		config.addDefault("Dragon.DragonsComet.Range", Double.valueOf(30.0));
		
		

		config.addDefault("Dragon.DragonsScales.Cooldown", Long.valueOf(2000));
		config.addDefault("Dragon.DragonsScales.Duration", Long.valueOf(10000));
		
		config.addDefault("Dragon.DragonsScales.ClickRadius", Double.valueOf(3.0));
		...
		config.addDefault("Dragon.DragonsSlam.Cooldown", Long.valueOf(2000));
		...
		config.addDefault("Dragon.DragonsBolt.Range", Double.valueOf(20.0));
		config.addDefault("Dragon.DragonsBolt.Hitbox", Double.valueOf(1.0));
